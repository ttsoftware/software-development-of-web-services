 ...
 * 
 */
@WebServiceClient(name = "HotelService", targetNamespace = "http://services/", wsdlLocation = "http://mars:8080/webservices/HotelService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://mars:8080/webservices/HotelService?wsdl");
