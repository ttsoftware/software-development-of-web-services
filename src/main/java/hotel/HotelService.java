 ...
 * 
 */
@WebServiceClient(name = "HotelService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:8080/webservices/HotelService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HOTELSERVICE_QNAME = new QName("http://services/", "HotelService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webservices/HotelService?wsdl");
     ...
     * 
     * @return
     *     returns HotelInterface
     */
    @WebEndpoint(name = "HotelServicePort")
    public HotelInterface getHotelServicePort() {
        return super.getPort(new QName("http://services/", "HotelServicePort"), HotelInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "HotelServicePort")
    public HotelInterface getHotelServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services/", "HotelServicePort"), HotelInterface.class, features);
    }
